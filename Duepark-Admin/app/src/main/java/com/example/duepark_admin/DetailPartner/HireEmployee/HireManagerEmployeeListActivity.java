...
public class HireManagerEmployeeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hire_manager_employee_list);
        ...
        Button hireManagerEmployeeBtn = findViewById(R.id.hireManagerEmployeeBtn);
        hireManagerEmployeeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String idData = null;
                ...
                BackgroundTask backgroundTask = new BackgroundTask(HireManagerEmployeeListActivity.this);
        ...
        initHireManagerEmployeeList();
    }

    private void initHireManagerEmployeeList(){
    ...
    class BackgroundTask extends AsyncTask<String, HireEmployee, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (keyword.equals("get"))
            {
                ...
                String url = base_url+"get_managerList_Admin.php?Entity=AdminApp&Role=Manager&ParkingId="+parkingid;
                //String url = "https://duepark.000webhostapp.com/get_parkingManagerHireData.php?designation="+params[1]+"&parkingid="+params[2];
                String returnData = getEmployeeData(url);
                return returnData;
...
/*                else if(params[1].equals("Admin")) {
                    String url = "https://duepark.000webhostapp.com/get_parkingManagerHireData.php?designation=" + params[1] + "&userid=" + params[2] + "&parkingid=" + params[3];
                    String returnData = getEmployeeData(url);
                    return returnData;
                }*/
            }
                ...
                String save_url = base_url+"add_managerParking_Admin.php";
                try{
                    ...
                    String data = URLEncoder.encode("ManagerIds","UTF-8")+"="+URLEncoder.encode(params[1],"UTF-8")+"&"+
                                    URLEncoder.encode("ParkingId","UTF-8")+"="+URLEncoder.encode(parkingid,"UTF-8")+"&"+
                                    URLEncoder.encode("Role","UTF-8")+"="+URLEncoder.encode("Manager","UTF-8");
                    bw.write(data);
                    bw.flush();
                    bw.close();
                    ops.close();
        ...
        protected void onPostExecute(String s) {
            if(s.equals("no")){
                Toast.makeText(ctx, "No Manager Found...", Toast.LENGTH_SHORT).show();
            }
            /*else if(s.equals("0")){
