...
public class DetailLocationPartnerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button locationNameEditBtn, locationTypeEditBtn, locationAddressEditBtn, saveBtn, deactivateBtn, activateBtn, setOpenTimeEditBtn, setCloseTimeEditBtn, carChargesEditBtn, bikeChargesEditBtn, passChargesEditBtn, carCapacityEditBtn, bikeCapacityEditBtn;
    private ArrayAdapter<String> dataAdapter;
    private String locationId, locationActiveState, parkingAcronym, generatedParkingId;
    private Location location;
    private SessionManager sessionManagerHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManagerHelper = new SessionManager(this);
        HashMap<String, String> employeeData = sessionManagerHelper.getUserDetails();
    ...
    public void onClick(View view) {
        if(view == locationNameEditBtn){
            ...
            if(locationActiveState.equals("0")){
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(DetailLocationPartnerActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            AlertDialog.Builder alertBuilder = new AlertDialog.Builder(DetailLocationPartnerActivity.this);
            ...
            alertBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    BackgroundTask backgroundTask = new BackgroundTask(DetailLocationPartnerActivity.this);
    ...
    public void onBackPressed() {
        Intent i = new Intent(DetailLocationPartnerActivity.this, LocationPartnerActivity.class);
        startActivity(i);
