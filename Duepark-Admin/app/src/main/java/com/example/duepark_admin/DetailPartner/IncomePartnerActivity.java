...
import com.example.duepark_admin.Adapter.LocationIncomeListAdapter;
...
public class IncomePartnerActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {

    private String TAG = "IncomePartnerActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_partner);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        dateET.setText(format.format(chosenDate));
        totalCashPayment = 0;
    ...
    private void getCurrentDate(){
        Date today = new Date();
        SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy");
        dateET.setText(format.format(today));
    }
    ...
    class BackgroundTask extends AsyncTask<String, IncomeList, String> {
        ...
        protected String doInBackground(String... strings) {
            String income_url = base_url+"get_incomeList.php?ParkingId="+parkingId+"&Date="+dateET.getText().toString().trim();
            //String income_url = base_url+"get_incomeList.php?ParkingId="+parkingId;
            try{
