<?php
    ...
    function getLocationData($locationId){
        ...
        $getLocationData_query = "select id, GeneratedLocationId, LocationName, LocationActiveState from ".$locationTable." where id = $locationId and LocationActiveState = false  limit 1";
        ...
        {
            if(mysqli_num_rows($getLocationData_result)){
